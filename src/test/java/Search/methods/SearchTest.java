...
public class SearchTest {
    ...
    /**
     * Assert that binarySearch returns negative one as index
     * when the element is not found in the array.
     */
    @Test
    public void binarySearchReturnsNegativeOneOnNotFound() {
        // Arrange
        int[] array = intArrayGenerator.generateRandomSequence(10);
        Arrays.sort(array);
     ...
     */
    @Test
    public void binarySearchReturnsNegativeOneOnEmptyArray() {
        // Arrange
        int[] array = new int[]{};
        Arrays.sort(array);
